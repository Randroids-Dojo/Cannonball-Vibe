...
OUT = ROOT / 'data/assets/vehicles/endurance-sedan-review/art-checkpoint-v27'
...
for manifest in sorted(HERE.glob('manifest-*.json')):
    ...
    target = OUT / f'art-checkpoint-v27-{number:02}.zip'
    repeat = HERE / f'art-checkpoint-v27-{number:02}-repeat.zip'
