...
for relative,expected in [
 ...
 ('qa/front-sheet29-proposal02/retention13.json','baaa5a5e967c8eefb9a32e3a4346a1c43e8661cc61badfda93718c51b8141a79'),
    ...
    for row in rows:
        ...
        domain=p.parent if relative.startswith('runtime/') else ROOT
        target=(domain/row['path']).resolve();assert target.is_relative_to(domain.resolve()),target
...
for p in (Path(__file__),HERE/'prepare.py',HERE/'build.py',HERE/'build02.py'):add(p)
