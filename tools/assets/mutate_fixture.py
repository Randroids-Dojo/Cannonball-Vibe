"""Create intentionally invalid Blender fixtures for asset-gate regression checks."""
...
def main() -> None:
    ...
    if args.mutation == "unapplied-scale":
        ...
        shader = bpy.data.materials["Material_Pavement"].node_tree.nodes.get("Principled BSDF")
        texture = bpy.data.materials["Material_Pavement"].node_tree.nodes.new("ShaderNodeTexImage")
        texture.image = image
        bpy.data.materials["Material_Pavement"].node_tree.links.new(
