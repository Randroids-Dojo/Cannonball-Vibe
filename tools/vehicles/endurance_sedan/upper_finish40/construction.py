...
from ..qa.upper_finish_report import COMPANION, INPUTS, NAMES, POLICY, SELECTOR, require
...
def construct(proof, root, stage_root):
    ...
    value = {
        'schema': 'source-upper-construction40.v1', 'policy': POLICY, 'source_phase': 'pre-lod',
        ...
        'native': installed, 'unowned_raw_before': protected, 'unowned_raw_unchanged': True,
