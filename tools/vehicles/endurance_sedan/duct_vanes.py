"""Retain original sections of six cosmetic duct vanes, unsaved.
...
def build():
    if any(n not in bpy.data.objects for n in TARGETS):raise ValueError('All six original duct vanes required')
