...
The declared Windows reference machine is available; only representative budget
capture and owner ratification remain open. No cloud service or paid
infrastructure is needed for this choice.
