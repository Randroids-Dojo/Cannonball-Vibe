...
public sealed partial class PrototypeHud : CanvasLayer
{
    ...
    public override void _Ready()
    {
        ...
        var title = CreateLabel(new Vector2(44, 38), 24);
        title.Text = "CANNONBALL // M0 FEEL";
        _speed = CreateLabel(new Vector2(44, 72), 32);
        _distance = CreateLabel(new Vector2(44, 112), 18);
        _streaming = CreateLabel(new Vector2(44, 140), 14);
        var help = CreateLabel(new Vector2(24, 1030), 16);
    ...
    private Label CreateLabel(Vector2 position, int fontSize)
    {
        var label = new Label { Position = position };
